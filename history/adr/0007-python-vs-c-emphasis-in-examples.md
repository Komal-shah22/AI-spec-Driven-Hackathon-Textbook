# ADR-0007: Python vs C++ Emphasis in Examples
...
-   **Faster Learning Curve:** Readers can focus more on understanding fundamental ROS 2 concepts and architectural patterns rather than struggling with complex language intricacies and build systems often associated with C++.
